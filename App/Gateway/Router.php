            ...
            if (gettype($route_entities[0]->getController()) === 'array') {
                ...
                if (class_exists($class)) {
                    if (method_exists($class, $route_entities[0]->getController()[1])) {
                        ...
                        echo "Mechod " . $route_entities[0]->getController()[1] . " does not exists" . " in class  " . $class;
                    }
                } else {
                ...
                if (class_exists(((object) $class_method[0])::class)) {
                    ...
                    if (method_exists(new $class(), $class_method[1])) {
                        ...
                        echo "Mechod " . $class_method[1] . " does not exists" . " in class  " . $class_method[0];
                    }
                } else {
                    echo "Mechod " . $class_method[1] . "does not exists";
                }
