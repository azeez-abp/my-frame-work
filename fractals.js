function fra(argument) {
    ...
    var canvas  = document.getElementById("cav"),
     ...
     var p0 = {x:0,y:-321},p1={x:278,y:160},p2={x:-278,y:160};
       fractal(p0,p1,p2,3) 

      function fractal(p0,p1,p2,limit){
        ...
        fractal(p0,pA,pC,limit-1) 
        fractal(pA,p1,pB,limit-1) 
        fractal(pC,pB,p2,limit-1) 
    }else{
